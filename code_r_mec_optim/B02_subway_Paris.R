...
thePath = getwd()
arcs = as.matrix(read.csv(paste0(thePath, "/../data_mec_optim/networks_subway/Paris/arcs.csv"), sep = ",", header = TRUE))  # loads the arc data
nodes = as.matrix(read.csv(paste0(thePath, "/../data_mec_optim/networks_subway/Paris/nodes.csv"), sep = ",", header = TRUE))  # loads the nodes data
head(arcs)
